      ...
      <div className="flex-1 flex justify-center gap-2 max-md:hidden">
        {user && !isMunicipal && (
          <>
            ...
            <Link to="/road-scanner" className={`px-4 py-2 rounded-xl text-[0.85rem] font-bold transition-all ${activePage === 'road-scanner' ? 'bg-[rgba(0,212,255,0.08)] text-cyan' : 'text-text2 hover:text-text hover:bg-[rgba(255,255,255,0.04)]'}`}>📷 Scanner</Link>
